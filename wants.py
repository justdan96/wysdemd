...
def add_should_service():
    # the "wants" are the services that should be started for a specific target
    # these are read from the Wants section of the target file
    # as well as the wants directory on the filesystem
    should_str = "# Wants : "
    ...
    if not is_service and prog == "default":
       ...
       if os.path.is_dir(real_wants_path):
